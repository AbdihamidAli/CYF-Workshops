...
// Answers:
/*
1- Math.trunc() this will always removes the decimal number from the given integer number 
regardless of if it is a positive or negative.

2- Math.floor() this will rounds down "moving to lower number" from right to the left from a given integer number.
*/
